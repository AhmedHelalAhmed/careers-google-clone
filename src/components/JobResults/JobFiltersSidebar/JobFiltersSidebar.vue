<template>
  ...
  >
    <section class="pb-5">
      <job-filters-sidebar-prompt></job-filters-sidebar-prompt>
      <job-filters-sidebar-skills></job-filters-sidebar-skills>
...
const parseSkillsSearchTerm = () => {
  const role: string = (route.query.role as string) || "";
